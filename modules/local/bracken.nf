process BRACKEN_DB {
    ...
    conda '/cpfs01/projects-HDD/cfff-47998b01bebd_HDD/rj_24212030018/miniconda3/envs/viroprofiler-bracken'
...
process BRACKEN {
    ...
    """
    kraken2 \\
        --db ${params.db}/kraken2evrd/kraken2_database \\
        --threads $task.cpus \\
    ...
    bracken \\
        -d ${params.db}/kraken2evrd/kraken2_database \\
